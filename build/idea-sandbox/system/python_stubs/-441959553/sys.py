...
base_exec_prefix = '/work/priv/python/python-tests/venv/bin/..'

base_prefix = '/work/priv/python/python-tests/venv/bin/..'
...
executable = '/work/priv/python/python-tests/venv/bin/python'

exec_prefix = '/work/priv/python/python-tests/venv/bin/..'
...
prefix = '/work/priv/python/python-tests/venv/bin/..'

real_prefix = '/usr/local/Cellar/python3/3.6.3/Frameworks/Python.framework/Versions/3.6'

version = '3.6.3 (default, Oct  4 2017, 06:09:38) \n[GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.37)]'
...
path = [
    '/work/priv/livetest/build/idea-sandbox/plugins/python-ce/helpers',
    '/work/priv/python/python-tests/venv/lib/python36.zip',
    '/work/priv/python/python-tests/venv/lib/python3.6',
    '/work/priv/python/python-tests/venv/lib/python3.6/lib-dynload',
    '/usr/local/Cellar/python3/3.6.3/Frameworks/Python.framework/Versions/3.6/lib/python3.6',
    '/work/priv/python/python-tests/venv/lib/python3.6/site-packages',
]
