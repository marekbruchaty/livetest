...
base_exec_prefix = '/usr/local/Cellar/python3/3.6.3/Frameworks/Python.framework/Versions/3.6'

base_prefix = '/usr/local/Cellar/python3/3.6.3/Frameworks/Python.framework/Versions/3.6'
...
exec_prefix = '/usr/local/Cellar/python3/3.6.3/Frameworks/Python.framework/Versions/3.6'
...
prefix = '/usr/local/Cellar/python3/3.6.3/Frameworks/Python.framework/Versions/3.6'
